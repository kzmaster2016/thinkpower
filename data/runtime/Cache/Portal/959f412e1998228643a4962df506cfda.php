		...
		<div class="news-con">
			<div class="container">
				<div class="row news-item">
					<div class="col-sm-4 item-cover"><img src="images/picjpg/news_2.jpg" alt=""></div>
					<div class="col-sm-2 item-data">
						<span class="date">01</span>
						<span class="month">JULY</span>
					</div>
					<div class="col-sm-6 item-con">
						<h4>Think Power Attended Global Source 2017</h4>
						<p>Think Power participated the four-day Global Source in Hongkong,Think Power participated the four-day Global Source in Hongkong</p>
						<a href="###">READ MORE</a>
					</div>
				</div>
				<div class="row news-item">
		...
		<div class="footer-con1">
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-6 col-sm-3">
						<dl>
							<dt>Product Business Unit</dt>
							<dd><a href="###">GPS Tracking Solution</a></dd>
							<dd><a href="###">Car Camere</a></dd>
							<dd><a href="###">Digital TV Receiver</a></dd>						 
						</dl>
					</div>
					<div class="col-xs-6 col-sm-3">
						<dl>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="hd">
							...
							<span>+86-0755-33985960</span><span>thinkpower@cntinkpower.com</span>
						</div>
					</div>
