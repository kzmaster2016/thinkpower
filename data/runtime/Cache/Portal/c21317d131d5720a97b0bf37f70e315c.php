		...
		<div class="news-con">
			<div class="container">
				...
				<div class="row news-item">
					<div class="col-sm-3 item-cover"><img src="<?php echo sp_get_asset_upload_path($smeta['thumb']);?>" alt=""></div>
					<div class="col-sm-2 item-data">
						<span class="date"><?php echo (date("d",strtotime($vo["post_date"]))); ?></span>
						<span class="month"><?php echo (date("M",strtotime($vo["post_date"]))); ?></span>
					</div>
					<div class="col-sm-7 item-con">
						<h4><a href="<?php echo U('News/article',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>"><?php echo ($vo["post_title"]); ?></a></h4>
						<p><?php echo (msubstr($vo["post_excerpt"],0,256)); ?></p>
						<a href="<?php echo U('News/article',array('id'=>$vo['object_id'],'cid'=>$vo['term_id']));?>">READ MORE</a>
					</div>
